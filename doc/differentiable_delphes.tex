...
%
% JINST-style preprint. Uses the standard jinst.cls document class
% distributed by the Journal of Instrumentation. The class file is
% available at https://jinst.sissa.it/jinst/ins_authors.jsp and must be
% present in the tree (or TEXMF path) at compile time; see
% doc/README.md for setup notes.
%
\documentclass[a4paper]{jinst}
